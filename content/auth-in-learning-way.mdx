...
![User Signup Workflow](/register-flow.png)

> maybe slightly different but this is how it works everywhere
...
![Access token Refresh Workflow](/access-token-refresh-workflow.png)
