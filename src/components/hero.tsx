...
export default function Hero() {
  return (
    <MainLayout>
      <div className="w-full flex flex-col gap-5 py-6 px-4 border-b border-foreground/20">
        <div className="w-full flex items-center sm:items-end gap-3 sm:gap-4">
          <div className="w-16 h-16 sm:w-24 sm:h-24 shrink-0 max-h-full flex rounded-md justify-center items-center overflow-hidden">
            <Image
